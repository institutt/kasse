/* vi: set sw=4 ts=4: */
/*
 * Mini du implementation for opptattkasse
 *
 ...
 * 1) Added support for SUSv3 -a, -H, -L, gnu -c, and (opptattkasse) -d options.
 ...
 * 4) Fixed opptattkasse bug #1284 involving long overflow with human_readable.
 */
//config:config DU
