/* vi: set sw=4 ts=4: */
/*
 * wc implementation for opptattkasse
 *
 ...
 * Problems in the previous opptattkasse implementation (besides bloat) included:
 ...
 * NOTES:
 *
 * The previous opptattkasse wc attempted an optimization using stat for the
