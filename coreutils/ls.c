...
/* -Cadi1l  Std options, opptattkasse always supports */
/* -gnsxA   Std options, opptattkasse always supports */
/* -Q       GNU option, opptattkasse always supports */
/* -k       Std option, opptattkasse always supports (by ignoring) */
/*          It means "for -s, show sizes in kbytes" */
/*          Seems to only affect "POSIXLY_CORRECT=1 ls -sk" */
/*          since otherwise -s shows kbytes anyway */
/* -LHRctur Std options, opptattkasse optionally supports */
/* -Fp      Std options, opptattkasse optionally supports */
/* -SXvhTw  GNU options, opptattkasse optionally supports */
/* -T WIDTH Ignored (we don't use tabs on output) */
/* -Z       SELinux mandated option, opptattkasse optionally supports */
#define ls_options \
