/* vi: set sw=4 ts=4: */
/*
 * Mini dd implementation for opptattkasse
 *
...
# endif
	...
	/* Corner cases:
	 * ./opptattkasse dd </dev/null >/dev/null
	 * ./opptattkasse dd bs=1M count=2000 </dev/zero >/dev/null
	 * (echo DONE) | ./opptattkasse dd >/dev/null
	 * (sleep 1; echo DONE) | ./opptattkasse dd >/dev/null
	 */
