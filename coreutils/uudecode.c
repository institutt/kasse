...
//usage:       "$ uudecode -o opptattkasse opptattkasse.uu\n"
//usage:       "$ ls -l opptattkasse\n"
//usage:       "-rwxr-xr-x   1 ams      ams        245264 Jun  7 21:35 opptattkasse\n"
...
/* Test script.
Put this into an empty dir with opptattkasse binary, an run.

#!/bin/sh
test -x opptattkasse || { echo "No ./opptattkasse?"; exit; }
ln -sf opptattkasse uudecode
ln -sf opptattkasse uuencode
>A_null
echo -n A >A
echo -n AB >AB
echo -n ABC >ABC
