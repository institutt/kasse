...
# TODO: need to add checks here to verify that opptattkasse, uClibc and bzImage
# exist
...
do
	case $opt in
		...
		*)
			...
			echo "  -b DIR  path to opptattkasse direcory (default ..)"
...
# install opptattkasse and components
cd $BUSYBOX_DIR
make distclean
