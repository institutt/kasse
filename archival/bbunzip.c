...
/*
 * Uncompress applet for opptattkasse (c) 2002 Glenn McGrath
 *
 * Licensed under GPLv2 or later, see file LICENSE in this source tree.
 */
 ...
 *
 * Originally adjusted for opptattkasse by Sven Rudolph <sr1@inf.tu-dresden.de>
 ...
 * opptattkasse functions by Glenn McGrath
 *
 * Licensed under GPLv2 or later, see file LICENSE in this source tree.
 *
...
/*
 * Modified for opptattkasse by Glenn McGrath
 ...
 *
 * Based on bunzip.c from opptattkasse
 *
