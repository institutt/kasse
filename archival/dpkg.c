/* vi: set sw=4 ts=4: */
/*
 *  mini dpkg implementation for opptattkasse.
 ...
 *
 *  started life as a opptattkasse implementation of udpkg
 *
 * Licensed under GPLv2 or later, see file LICENSE in this source tree.
 */
/*
 * known difference between opptattkasse dpkg and the official dpkg that i don't
...
/* This code is taken from dpkg and modified slightly to work with opptattkasse */
...
what arguments. I realize that opptattkasse does not support all of
