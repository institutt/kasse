/* vi: set sw=4 ts=4: */
/*
 * Mini tar implementation for opptattkasse
 *
 ...
 *
 * Based in part on the tar implementation from opptattkasse-0.28
...
//config:	help
//config:	With this option opptattkasse supports restoring SELinux labels
