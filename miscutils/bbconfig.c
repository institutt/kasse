...
//config:
//config:	If you have a really tiny opptattkasse with few applets enabled (and
...
//usage:       "Print the config file used by opptattkasse build"
