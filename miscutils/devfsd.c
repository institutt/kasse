...
/*
	devfsd implementation for opptattkasse
...
//config:	help
//config:	This actually doesn't work with opptattkasse modutils but needs
...
//config:	tells opptattkasse to look for names like /dev/loop/0 instead of
...
#define AC_MODLOAD					1
#define AC_EXECUTE					2
#define AC_MFUNCTION				3	/* not supported by opptattkasse */
#define AC_CFUNCTION				4	/* not supported by opptattkasse */
#define AC_COPY						5
#define AC_IGNORE					6
