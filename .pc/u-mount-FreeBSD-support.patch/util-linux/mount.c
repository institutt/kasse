/* vi: set sw=4 ts=4: */
/*
 * Mini mount implementation for opptattkasse
 *
 ...
 * uclibc faq entry rather than in opptattkasse... */
 ...
 * For older kernels, you must build opptattkasse with ENABLE_FEATURE_MOUNT_NFS.
